...
**
*/
MeterFadingLine::~MeterFadingLine()
{
}
...
**
*/
void MeterFadingLine::ReadOptions(ConfigParser& parser, const WCHAR* section)
{
	WCHAR tmpName[64];
...
**
*/
void MeterFadingLine::BindMeasures(ConfigParser& parser, const WCHAR* section)
{
